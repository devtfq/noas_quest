...
public class EGA_DemoLasers : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (Cam != null)
        {
            ...
            if (Physics.Raycast(FirePoint.transform.position, FirePoint.transform.forward, out hit, MaxLength)) //CHANGE THIS IF YOU WANT TO USE LASERRS IN 2D: if (hit.collider != null)
            {
